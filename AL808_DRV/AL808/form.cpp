...
void Form::on_doubleSpinBox_PV_editingFinished()
{
    Commend CPV;
    CPV.id="PV";
    CPV.value=ui->doubleSpinBox_PV->value();
    emit  SendChange(CPV );

}

void Form::on_doubleSpinBox_OP_editingFinished()
{
    Commend COP;
    COP.id="OP";
    COP.value=ui->doubleSpinBox_OP->value();
    emit   SendChange( COP);
}

void Form::on_doubleSpinBox_SP_editingFinished()
{
    Commend CSP;
    CSP.id="SP";
    CSP.value=ui->doubleSpinBox_SP->value();
    emit  SendChange(CSP);
}
